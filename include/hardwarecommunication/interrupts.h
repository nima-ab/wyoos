#ifndef __MYOS_HARDWARECOMMUNICATIONS__INTERUPTS_H
#define __MYOS_HARDWARECOMMUNICATIONS__INTERUPTS_H
...
namespace myos
{
    namespace hardwarecommunication
    {
        ...
        protected:
            ...
            myos::common::uint32_t DoHandlerInterrupt(myos::common::uint8_t interrupt, myos::common::uint32_t esp);
